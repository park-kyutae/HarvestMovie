	...
	<div class="container">
		<div class="row">
			<div class="col-6 border border-secondary mx-auto my-3 pa-5">
				<h2 class="my-3">비밀번호 수정</h2>
				<form class="form-floating" action="modifyPassword.do" method="post" id="password_form">
				 
				 <div class="row">
				 	
				 	<div class="col-12">
				 	<div class="form-floating mb-3">
						<input class="form-control mt-2" type="text" name="id" id="id" placeholder="아이디" maxlength="12">
					...
					<div class="form-floating mb-3">
					<input class="form-control mt-2" type="password" name="origin_passwd" id="origin_passwd" 
							 placeholder="현재 비밀번호" maxlength="12">
					<label for="origin_passwd">현재 비밀번호</label> 
					</div>
					 
					 <div class="form-floating mb-3">
					<input class="form-control mt-2" type="password"
							name="pw" id="pw"  placeholder="새비밀번호" maxlength="12">
					...
					<div class="my-2 float-end">
						<input class="btn btn-primary" type="submit" value="비밀번호수정"> 
