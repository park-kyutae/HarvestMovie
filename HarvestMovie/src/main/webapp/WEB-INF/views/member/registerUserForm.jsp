...
<body>
	<div class="container">
		...
		<div class="row d-flex justify-content-end">
			...
			<div class="col-sm-6">
				<!-- 두번쨰 div -->
				<form class="navbar-form navbar-left" action="registerUser.do"
					method="post">
					...
					<label for="exampleFormControlInput1" class="form-label">패스워드
						확인</label> <input type="password" class="form-control"
						id="exampleFormControlInput1" placeholder="패스워드 확인"> <label
						for="exampleFormControlInput1" class="form-label">이름</label> <input
						type="text" class="form-control" name="name" id="name"
						placeholder="이름"> <label for="exampleFormControlInput1"
