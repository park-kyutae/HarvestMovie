            ...
            <form class="needs-validation" novalidate method="post">
                <div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="mv_director" id="mv_director" placeholder
                                required>
                        <div class="invalid-feedback">
                            감독을 입력해야 합니다.
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="mv_actor" id="mv_actor" placeholder
                               required>
                        <div class="invalid-feedback">
                            배우를 입력해야 합니다.
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="mv_writer" id="mv_writer" placeholder
                               required>
                        <div class="invalid-feedback">
                            각본을 입력해야 합니다.
                        </div>
                    ...
                    <div class="col-sm-20">
                        ...
                        <div class="row">
                            <div class="col col-md-6">
                                <input type="text" id="mv_trailer" name="mv_trailer" placeholder class="form-control"required>
                            </div>
                    ...
                    <div>
                        <h4>포스터</h4>
                        <img src="${pageContext.request.contextPath}/images/img_not_exist.jpg" id="mv_poster"
                    ...
                    <div>
                        <h4>메인 사진</h4>
                        <img src="${pageContext.request.contextPath}/images/img_not_exist.jpg" id="mv_main_pic"
                             width="300px" class="pic"><br>
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <img src="${pageContext.request.contextPath}/images/img_not_exist.jpg" class="pic img-fluid"
