...
<div class="container">
    <div class="row">
        <a class="text-decoration-none text-dark" href="${pageContext.request.contextPath}/movie/review/review.do?mv_num=${param.mv_num}">
                ...
                <div class="input-group">
                    <form action="reviewModify.do?mv_num=${param.mv_num}" method="post" class="form-control p-3">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <input type="submit" value="수정" class="btn btn-secondary"></div>
                    </form>
                </div>
            </div>
        </div>
