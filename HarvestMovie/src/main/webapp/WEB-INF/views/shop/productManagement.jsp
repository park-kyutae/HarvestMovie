...
<body>
	...
	<div class="container-fluid">
		<div class="row flex-nowrap">
			...
			<div>
				<h2 class="text-start">상품관리</h2>
				<div class="container fliud float-start">
					<div class="row">
						<div class="col-12">
							<c:if test="${count} == 0">
								<div class="result-display">저장된 게시물이 없음~~!~!~</div>
							</c:if>
							<c:if test="${count > 0}">
								<!-- On tables -->
									...
									<c:forEach var="product" items="${list}">
										<tr>
											...
											<td style='width: 50%;'><a
												...
												href="productDetail.do?pd_num=${product.pd_num}">${fn:substring(product.pd_content,0,25)}...</a></td>
							...
							<div>
								<input class="btn btn-primary" type="button" value="상품 추가"
									...
									value="ShopMain" onclick="location.href='shopMain.do'">
							</div>
						</div>
					</div>
				</div>
