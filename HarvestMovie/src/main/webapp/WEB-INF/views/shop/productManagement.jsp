    ...
    <div class="row flex-nowrap">
        ...
        <div class="col-8">
            ...
            <div class="container fliud float-start">
                    ...
                    <table class="table table-primary table-hover text-center">
                        ...
                        <c:forEach var="product" items="${list}">
                            <tr>
                                ...
                                <td style='width:50%;'><a style="text-decoration: none;color:black;"
                                                          href="productDetail.do?pd_num=${product.pd_num}">${fn:substring(product.pd_content,0,25)}...</a>
                                </td>
                ...
                <div>
                    <input class="btn btn-primary" type="button" value="상품 추가"
                           onclick="location.href='insertProductForm.do'">
                    <input class="btn btn-primary float-end" type="button" value="ShopMain"
